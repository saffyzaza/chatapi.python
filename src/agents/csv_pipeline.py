    ...
    if domain.code == "d0":
        ...
        insight = _run_agent(
            ...
            (
                f"{history_section}"
                f"คำถาม: {prompt}\n\n"
                "ตอบเป็นภาษาไทยที่เป็นทางการ สุภาพ และเป็นกลาง ใช้ถ้อยคำเชิงวิชาการ/ราชการ "
                "ตรงประเด็น ถูกต้องตามหลักวิชาการ และน่าเชื่อถือ "
                "หากเนื้อหามีหลายประเด็น อาจจัดเป็นย่อหน้าหรือหัวข้อย่อยให้อ่านง่าย "
                "แต่ไม่จำเป็นต้องทำเป็นรายงานผู้บริหารเต็มรูปแบบ "
                "หลีกเลี่ยงภาษาพูดและถ้อยคำกันเอง"
            ),
