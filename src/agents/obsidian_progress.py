...
_OBSIDIAN_AGENTS = [
    {"name": "Obsidian Knowledge Searcher", "icon": "🔍", "order": 0},
    {"name": "Health Knowledge Answer Writer", "icon": "📋", "order": 1},
]
...
def emit_progress(
    ...
    if not q:
        return
    meta = next((a for a in _OBSIDIAN_AGENTS if a["name"] == agent_name), None)
    event = AgentProgress(
